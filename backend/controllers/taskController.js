import Task from "../models/taskModel.js"; // ✅ Make sure file ends with `.js`

// CREATE A NEW TASK
export const createTask = async (req, res) => {
    try {
        // ✅ FIX: `res.body` should be `req.body`
...
export const updateTask = async (req, res) => {
    try {
        ...
        // ✅ FIX: Logic for checking and converting 'completed' field
...
export const deleteTask = async (req, res) => {
    try {
        // ✅ FIX: `findByIdAndDelete` doesn't support `{owner}` directly, use `findOneAndDelete`

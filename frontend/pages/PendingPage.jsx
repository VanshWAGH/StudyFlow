...
import { layoutClasses } from '../src/assets/dummy';
import { ListChecks, Filter, Clock, Plus, SortDesc, SortAsc, Award } from 'lucide-react';
...
const PendingPage = () => {
  ...
  const handleToggleComplete = async (taskId, currentStatus) => {
    try {
      await axios.put(`${API_BASE}/${taskId}/completed`, {
        completed: currentStatus ? 'No' : 'Yes'
      }, {
        headers: { Authorization: `Bearer ${localStorage.getItem('token')}` }
      });
      refreshTasks();
  ...
  return (
    <div className={layoutClasses.container}>
      ...
      <div className={layoutClasses.addTaskBox} onClick={() => setShowModal(true)}>

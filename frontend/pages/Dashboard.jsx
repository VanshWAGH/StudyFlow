...
import { ADD_BUTTON, EMPTY_STATE, FILTER_OPTIONS, HEADER, LABEL_CLASS, TAB_BASE, TABS_WRAPPER, WRAPPER, STATS_GRID, STAT_CARD, ICON_WRAPPER, VALUE_CLASS, FILTER_WRAPPER, SELECT_CLASSES, TAB_ACTIVE, TAB_INACTIVE, FILTER_LABELS } from '../src/assets/dummy'
import { CalendarIcon, HomeIcon, Plus, Flame, Filter } from 'lucide-react'
      ...
      <div className={HEADER}>
        <div className='min-w-0'>
          <h1 className='text-xl md:text:3xl font-bold text-gray-800 flex items-center gap-2'>
            <HomeIcon className='text-purple-500 w-5 h-5 md:s-6 md:h-6 shrink-0'/>  

...
import { DEFAULT_TASK } from '../src/assets/dummy';
import { AlignLeft, Calendar, CheckCircle, PlusCircle, Save, X, Flag } from 'lucide-react';
import { baseControlClasses, priorityStyles } from '../src/assets/dummy';
      ...
      <div className='bg-white border border-purple-100 rounded-xl max-w-md w-full shadow-lg relative p-6 animate-fadeIn'>
        ...
        <form onSubmit={handleSubmit} className='space-y-4'>
            ...
            <div>
                ...
                className={baseControlClasses} placeholder='Add details about you task'/>
            </div>
            ...
            <div>
                ...
                <div className='flex gap-4'>
                    {[{val:'Yes', label:'Completed'},
                      {val:'No', label:'In Progress'}].map(({val, label}) => (
